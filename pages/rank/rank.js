...
Page({
  ...
  onLoad: function () {
    ...
    var ranklistUrl = app.globalData.ajaxBase + app.globalData.ranklist
  ...
  handlelower() {
    ...
    var ranklistUrl = app.globalData.ajaxBase + app.globalData.ranklist + "?page=" + pageno
    if (tp > pg) {
      this.getMovieListData(ranklistUrl, 'ranklist');
    }

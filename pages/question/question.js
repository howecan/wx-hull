...
Page({
  ...
  data: {
    ...
    mainpic: app.globalData.download + app.globalData.mainpic
  },
  ...
  onLoad: function (options) {
    var askslistUrl = app.globalData.ajaxBase + app.globalData.askslist
  ...
  formSubmit: function (e) {
    ...
    wx.request({
      url: app.globalData.ajaxBase + app.globalData.answerurl,
      method: 'POST',
  ...
  handlelower(){
    ...
    var askslistUrl = app.globalData.ajaxBase + app.globalData.askslist + "&page=" + pg
    if (tp > pg ) {
      this.getMovieListData(askslistUrl, 'askslist');
    }  
